...
<head>
    <meta charset="UTF-8">
    <title>Galle Sri Lanka | Splendors Taxi & Tours</title>
...
<body>
    ...
    <header class="galle">
        <main>
            <section class="videoSection">
                <h3>Welcome To Galle Sri Lanka</h3>
    ...
    <style>
        .galle {
            ...
            background-image: linear-gradient(rgba(0, 0, 0, 0.3), rgba(0, 0, 0, 0.15)),
                url("img/galle/oliver-frsh-EBxsNaN0mig-unsplash.jpg");
    ...
    <section class="discription">
        ...
        <div class="leftImg row">
            <div class="left">
                <div class="img">
                    <i>
                        <input checked type="radio" name="s" style="background-image: url('img/galle/random1.jpg');"
                            title="Random Picture 1">
                        <input type="radio" name="s" style="background-image: url('img/galle/random2.jpg');"
                            title="Random Picture 2">
                        <input type="radio" name="s" style="background-image: url('img/galle/random3.jpg');"
                            title="Random Picture 3">
                        <input type="radio" name="s" style="background-image: url('img/galle/random4.jpg');"
                            title="Random Picture 4">
                        <input type="radio" name="s" style="background-image: url('img/galle/random5.jpg');"
            ...
            <div class="right">
                <div class="rightContent">
                    ...
                    <div class="container">
                        <span class="fa-solid fa-check"></span>
                        <span class="text">Coordinates: &nbsp;6°3′13″N 80°12′42″E</span>
                    </div> <br> <br>
                    <div class="container">
                        <span class="fa-solid fa-check"></span>&nbsp;
                        <span class="text">Elevation: &nbsp; 0 m (0 ft)</span>
                    </div> <br> <br>
                    <div class="container">
                        <span class="fa-solid fa-check"></span>&nbsp;
                        <span class="text">Area Code: &nbsp;091</span>
                    </div> <br> <br>
                    <div class="container">
                        <span class="fa-solid fa-check"></span>&nbsp;
                        <span class="text">Population(2020): &nbsp;93,1185</span>
                    </div> <br> <br>
                    <div class="container">
                        <span class="fa-solid fa-check"></span>&nbsp;
                    ...
                    <div class="container">
                        <span class="fa-solid fa-check"></span>&nbsp;
                        <span class="text">Demonym: &nbsp; Galleans</span>
                    </div> <br> <br>
                    </p>
                </div>
            </div>
    ...
    <video class="vid" controls>
        <source src="http://commondatastorage.googleapis.com/gtv-videos-bucket/sample/BigBuckBunny.mp4"
            ...
            <img src="img/galle/10+ Incredible Things To Do In Galle Fort, Sri Lanka _ The Common Wanderer (1).jpg"
                class="img-responsive">
            <img src="img/galle/Sunset, lighthouse in galle.jpg" class="img-responsive">
            <img src="img/galle/10+ Incredible Things To Do In Galle Fort, Sri Lanka _ The Common Wanderer.jpg"
                class="img-responsive">
            <img src="img/galle/Amangalla.jpg"
                class="img-responsive">
            <img src="img/galle/Galle Fort - Galle, Sri Lanka.jpg" class="img-responsive">
            <img src="img/galle/Galle Fort_ Things to do and How to Visit.jpg" class="img-responsive">
            <img src="img/galle/Things to do in Galle, Sri Lanka_.jpg" class="img-responsive">
            <img src="img/galle/Galle Lighthouse - Galle, SriLanka.jpg" class="img-responsive">
